...
public class RoomPanel : BasePanel
{
    ...
    private string nowType = "none";
    private string hostIpAddr = "0.0.0.0";
    ...
    private void Update()
    {
        ...
        if (type != nowType)
        {
            ...
            {
                nowType = type;
                manager.networkAddress = hostIpAddr;
                manager.StartClient();
            }
        }
    }
    ...
    // 开始游戏响应
    public void OnStartResponse(ReturnCode returnCode, String type, String hostIpAddr)
    {
        ...
        if (returnCode == ReturnCode.Success)
        {
            ...
            Debug.Log("Set as " + type);
            if (type == "host" || type == "client") this.type = type;
            if (type == "client") this.hostIpAddr = hostIpAddr;
        }
