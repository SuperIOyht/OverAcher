...
public class SpeedShoes : NetworkBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "TeamRed" || other.tag == "TeamBlue")
        {
            ...
            player.warriorMovementController.walkSpeed *= SpeedIncrease;
            player.warriorMovementController.runSpeed *= SpeedIncrease;
